...
function Electronic() {
  ...
  const videos = [
    { src: "https://www.youtube.com/embed/flACsJig-64?si=WHG4PzoKgD7i1Acv", title: "Chief Minister of Sindh, Syed Murad Ali Shah visited TDF's MagnifiScience Centre",duration: "2:44" },
    { src: "https://www.youtube.com/embed/Wu5JuyFHK0Q?si=cGf4Iwp3Ax2NdXkb", title: "The Chief Minister of Sindh, Syed Murad Ali Shah, visited TDF's MagnifiScience Centre",duration: "2:48" },
  ...
  const thumbnails = [
    ...
    { img: "/src/assets/imagee/thumb2.jpg", title: "The Chief Minister of Sindh, Syed Murad Ali Shah, visited TDF's MagnifiScience Centre" },
