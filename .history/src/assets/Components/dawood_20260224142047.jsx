...
function Dawood() {
  ...
  useEffect(() => {
    ...
    const url = "https://wpstaging.a2zcreatorz.com/magnifi-react/wp-json/wp/v2/pages?slug=the-dawood-foundation&_embed";
      ...
      <Container>
        <Row className="align-items-center">
          ...
          <Col md={6} className="pe-md-5">
            <h2 
              style={{ color: '#e65c2e', fontWeight: 'bold', fontSize: '2.5rem', marginBottom: '25px' }}
