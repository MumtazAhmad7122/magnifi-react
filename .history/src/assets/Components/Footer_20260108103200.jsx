    ...
    <footer className='pt-5 pb-5'>
     <Container>
      ...
      <div className='social-links d-flex align-ite-center'>
        <Link to="#" className='nav-link text-white pe-2'><FaFacebookF size={20} /></Link>
        <Link to="#" className='nav-link text-white pe-2'><FaTwitter size={20} /></Link>
        <Link to="#" className='nav-link text-white pe-2'><FaYoutube size={20} /></Link>
        <Link to="#" className='nav-link text-white pe-2'><FaLinkedinIn size={20} /></Link>
         <Link to="#" className='nav-link text-white pe-2'><FaInstagram size={20} /></Link>
         <Link to="#" className='nav-link text-white pe-2'><FaTiktok size={20} /></Link>
      </div>
      </Container>     
    </footer>
  )
