...
function Electronic() {
  ...
  const videos = [
    ...
    { src: "<iframe width="560" height="315" src="https://www.youtube.com/embed/Wu5JuyFHK0Q?si=cGf4Iwp3Ax2NdXkb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>", title: "Oblivion: Official Teaser Trailer" },
