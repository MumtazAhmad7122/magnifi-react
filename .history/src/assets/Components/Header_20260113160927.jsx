...
const [isScrolled, setIsScrolled] = useState(false);
  ...
  <div className="dropdown-menu submenu-right">
    <NavDropdown.Item as={Link} to="/testimonials/print">
     <Link className="nav-link text-capitalize" to="#"></Link> Print Media
    </NavDropdown.Item>
    <NavDropdown.Item as={Link} to="/testimonials/electronic">
      <Link className="nav-link text-capitalize" to="#"></Link>Electronic Media
    </NavDropdown.Item>
    <NavDropdown.Item as={Link} to="/testimonials/social">
    <Link className="nav-link text-capitalize" to="#"></Link>  Social Media
    </NavDropdown.Item>
  </div>
</div>
            </NavDropdown>
