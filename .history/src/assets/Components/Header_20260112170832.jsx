...
const [isScrolled, setIsScrolled] = useState(false);
  ...
  return (
    ...
    <NavDropdown.Item as={Link} to="#" className="text-uppercase">Visit Info</NavDropdown.Item>
              ...
              <NavDropdown.Item as={Link} className="nav-link text-uppercase" to="#">Would You Like Us to Visit You</NavDropdown.Item>
              <NavDropdown.Item as={Link} className="nav-link text-uppercase" to="#">Facilities</NavDropdown.Item>
              <NavDropdown.Item as={Link} className="nav-link text-uppercase" to="#">Terms & Conditions</NavDropdown.Item>
            </NavDropdown>
                    <NavDropdown title="Exhibitions" id="basic-nav-dropdown">
    <NavDropdown.Item as={Link} to="#" className="text-uppercase">Exhibitions</NavDropdown.Item>
              <NavDropdown.Item as={Link} className="nav-link text-uppercase" to="#">Kids WOrld Karachi</NavDropdown.Item>
              <NavDropdown.Item as={Link} className="nav-link text-uppercase" to="#">The World Within Us</NavDropdown.Item>
              <NavDropdown.Item as={Link} className="nav-link text-uppercase" to="#">The Physical Worlds</NavDropdown.Item>
              <NavDropdown.Item as={Link} className="nav-link text-uppercase" to="#">Our Creation Our Worlds</NavDropdown.Item>
              <NavDropdown.Item as={Link} className="nav-link text-uppercase" to="#">OutDoor Activities</NavDropdown.Item>
            </NavDropdown>
