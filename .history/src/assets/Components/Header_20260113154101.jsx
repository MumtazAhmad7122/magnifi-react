...
const [isScrolled, setIsScrolled] = useState(false);
  ...
  return (
    ...
    <NavDropdown.Item as={Link} to="#" className=" text-uppercase">Media</NavDropdown.Item>
              ...
              <NavDropdown.Item as={Link} className="nav-link text-capitalize " to="#">Media Coverage</NavDropdown.Item>
              <NavDropdown.Item as={Link} className="nav-link text-capitalize" to="#">Testiomonials</NavDropdown.Item>
            </NavDropdown>
