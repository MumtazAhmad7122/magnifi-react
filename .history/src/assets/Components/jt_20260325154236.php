...
function render_isl_cards($slug) {
    ...
    elseif (filter_var($f_url, FILTER_VALIDATE_URL) && !preg_match('/\.(pdf|jpg|jpeg|png|gif|zip|docx|xlsx)$/i', $f_url)) {
        // If the URL contains a hash (#), it's likely an internal tab link
