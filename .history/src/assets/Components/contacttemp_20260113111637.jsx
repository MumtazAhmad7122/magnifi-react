  ...
  return (
    <section className='contact-sec'>
     ...
     <div className='ct-frm'>
      <form >
        <Col md={12}>
       <input type='text' placeholder='Name' className='form-control position-relative bg-transperent'></input> 
       </Col>
       <Col md={12}>
       <input type='text' placeholder='Organization' className='form-control position-relative'></input> 
       </Col>
       <Col md={12}>
