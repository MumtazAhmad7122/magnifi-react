    ...
    <section className='contact-sec'>
     ...
     <div className='ct-frm'>
      <form>
       ...
       <Col md={12}>
       <select>
        <option value="" className='form-control'>Select Age Group</option>
       ...
       <Col md={12}>
       <select>
        <option value="" className='form-control'>Select Gender</option>
       ...
       <Col md="12">
       <textarea className='h-25' className='form-control'></textarea>
       </Col>
       <Col md="12">
