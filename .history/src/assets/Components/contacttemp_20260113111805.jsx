  ...
  return (
    <section className='contact-sec'>
     ...
     <div className='ct-frm'>
      <form >
        <Col md={12}>
       <input type='text' placeholder='Name' className='form-control position-relative bg-transparent'></input> 
       </Col>
       <Col md={12}>
       <input type='text' placeholder='Organization' className='form-control position-relative bg-transparent'></input> 
       </Col>
       <Col md={12}>
       <input type='text' placeholder='Email' className='form-control position-relative bg-transparent'></input> 
       </Col>
       <Col md={12}>
       <input type='text' placeholder='Contact Number' className='form-control position-relative bg-transparent'></input> 
       </Col>
       <Col md={12}>
       <select className='form-control position-relative bg-transparent'>
       ...
       <Col md={12}>
       <select className='form-control posoition-relative'>
       ...
       <div className='slt'>
        ...
        <label><input type='radio' value=""/>Very Dissatisfied</label>
        <label><input type='radio' value=""/>Dissatisfied</label>
        <label><input type='radio' value=""/>Neutral</label>
        <label><input type='radio' value=""/>Satisfied</label>
        <label><input type='radio' value=""/>Very Satisfied</label>
       </div>
       </Col>
       <Col md="12">
       <textarea className='h-25 form-control p-relative'></textarea>
       </Col>
       <Col md="12">
