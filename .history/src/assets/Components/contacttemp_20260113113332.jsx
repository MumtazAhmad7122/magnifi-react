     ...
     <div className='ct-frm'>
      <form >
       ...
       <div className='slt'>
        ...
        <label className='pe-2'><input type='radio' value=""/>Very Dissatisfied</label>
        <label className='pe-2'><input type='radio' value=""/>Dissatisfied</label>
        <label className='pe-2'><input type='radio' value=""/>Neutral</label>
        <label className='pe-2'><input type='radio' value=""/>Satisfied</label>
