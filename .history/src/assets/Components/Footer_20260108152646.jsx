...
function Footer() {
  return (
    <footer className='pt-5 pb-5'>
      <div className='top-bar pt-3 pb-3 w-75 mx-auto text-center'>
        <div className='top-image'>
         <img src="/src/assets/imagee/Foodology-2-scaled.jpg" className='img-fluid'/> 
         <div className='usr-frm'>
          <h4 className='text-white'>Subscribe to Our eNewsletter</h4> 
       <p className='text-white'>Stay up to date with the latest news on events, exhibitions and special offers at MSC</p>
           <form className="w-50  d-flex items-center mx-auto w-75">
        ...
        <button
          type="submit"
          className="bg-red-600 text-white px-5 py-3 rounded-full hover:bg-red-700 transition float-end w-50"
        >
          **Sign Up Now**
        </button>
     ...
     <Container>
      ...
      <div className='social-blk pt-5 pb- main-social'>
        <h6 className='text-white pb-3'>Connect With Us</h6>
      <div className='social-links d-flex align-ite-center pb-5'>
        ...
        <Link to="#" className='nav-link text-white pe-4'><FaYoutube size={25} /></Link>
        <Link to="#" className='nav-link text-white pe-4'><FaLinkedinIn size={25} /></Link>
         <Link to="#" className='nav-link text-white pe-4'><FaInstagram size={25} /></Link>
         <Link to="#" className='nav-link text-white pe-4'><FaTiktok size={25} /></Link>
      </div>
      </div>
      </Container>
      <div className='last-row pt-5'>
        <Container>
         <Row>
          <Col md={7}>
          <div className='last-link d-flex'>
           <Link to="#" className='nav-link text-white pe-3'>Sitemap</Link>
           <Link to="#" className='nav-link text-white pe-3'>Terms of Entry</Link>
            <Link to="#" className='nav-link text-white pe-3'>© The Dawood Foundation’s MagnifiScience Centre 2021 - 2025</Link>
          </div>
          </Col>
          <Col md={5}>
          <div className='aspc-img d-flex align-item-center '>
           <img src='/src/assets/imagee/aspac.webp' className='w-25 pe-3'/>
           <img src='/src/assets/imagee/Logo-ICOM.png' className='w-25 pe-3'/>
           <img src='/src/assets/imagee/pcp-1.png' className='w-25 pe-3'/>
