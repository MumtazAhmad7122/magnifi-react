  ...
  const newsletterData = [
    {
      ...
      title: "Karachi’s TDF Ghar and MagnifiScience Centre declared museums by Sindh governmentKARACHI: The Dawood Foundation (TDF) announced on Wednesday their flagship educational attractions in Karachi, the TDF MagnifiScience Centre and the TDF Ghar have been granted the status of museums by the Sindh government.",
      ...
      image: "./src/assets/imagee/sletter1.jpg", 
      reverse: false
    },
    {
      id: 2,
          ...
          >
            ...
            <div className="col-lg-5">
              <div className={`content-card ${item.reverse ? 'overlap-right' : 'overlap-left'}`}>
                ...
                <h2 className="news-title" style={{fontSize:'21px!important'}}>{item.title}</h2>
