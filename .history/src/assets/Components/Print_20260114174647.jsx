...
const Newsletters = () => {
  const newsletterData = [
    ...
    },
    {
      ...
      image: "./src/assets/imagee/print10.webp",
      reverse:true
    },
     {
      id: 7,
      date: "March 23, 2025",
      title: "Hussain Dawood awarded Hilal-i-Imtiaz for services to Pakistan in philanthropy",
      description: "In recognition of his contributions to education and community development, Mr. Hussain Dawood has been awarded the Hilal-i-Imtiaz, one of Pakistan’s highest civilian honours.",
      image: "./src/assets/imagee/print12.jpg",
      reverse:false
    },
    {
      id: 8,
      date: "November 08, 2024",
      title: "Goethe-Institut’s Science Film Festival 2024 opens",
      description: "KARACHI: The Goethe-Institut has organized the Science Film Festival 2024 at the Dawood Foundation’s MagnifiScience Centre here on Thursday.",
      image: "./src/assets/imagee/print13.jpg",
      reverse:true
    },
    {
      id: 9,
      date: "August 27, 2024",
      title: "MagnifiScience Centre Includes an Exhibition About Oceans",
      description: "The Dawood Foundation’s MagnifiScience Centre on Monday launched its latest exhibit, Ocean Odyssey, on the third floor of the Shahzada Dawood Building.",
      image: "./src/assets/imagee/print14.png",
      reverse:false
    }
  ];
    ...
    <section className="newsletter-section">
      <div className="container">
        ...
        {newsletterData.map((item) => (
          <div 
            key={item.id} 
            className={`row align-items-center mb-5 pb-5 ${item.reverse ? 'flerow-reverse' : ''}`}
          >
