...
function Footer() {
  return (
    <footer className='pt-5 pb-5'>
      <div className='top-bar pt-5 pb-5 w-75 mx-auto text-center'>
       ...
       <p className='text-white'>Stay up to date with the latest news on events, exhibitions and special offers at MSC</p>
           <form className="w-75  d-flex items-center  mx-auto ">
        
        {/* Email Input */}
        <input
          type="text"
          placeholder="Email"
          className="flex-grow px-4 py-3 text-gray-700 outline-none w-100"
          required
        />
        ...
        <button
          type="submit"
          className="bg-red-600 text-white px-5 py-3 rounded-full me-2 hover:bg-red-700 transition w-50"
        >
          **Sign Up Now**
        </button>
