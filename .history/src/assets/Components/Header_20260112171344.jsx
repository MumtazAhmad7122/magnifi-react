...
const [isScrolled, setIsScrolled] = useState(false);
  ...
  return (
    ...
    <NavDropdown.Item as={Link} to="#" className="">Visit Info</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="#">School Visits</NavDropdown.Item>
              <NavDropdown.Item as={Link} className="nav-link " to="#">Group Visits</NavDropdown.Item>
    ...
    <NavDropdown.Item as={Link} to="#">Exhibitions</NavDropdown.Item>
              <NavDropdown.Item as={Link} className="nav-link text-lowercase " to="#">Kids WOrld Karachi</NavDropdown.Item>
