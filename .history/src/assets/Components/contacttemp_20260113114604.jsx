  ...
  return (
    <section className='contact-sec pt-5'>
     ...
     <div className='ct-info'>
      ...
      <p className=''>We’re here to answer your questions, hear your feedback, and provide the support you need. Whether you want to learn more about our educational resources, explore collaboration opportunities, or simply say hello, our team is ready to assist you.</p>
