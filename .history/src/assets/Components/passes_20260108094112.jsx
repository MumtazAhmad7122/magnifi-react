...
function Passes() {
  ...
  const priceDetailss = [
    { title: "Single membership price", price: "Rs 4000" },
    { title: "Family of 2", price: "Rs. 17,500" },
    { title: "Family of 3", price: "Rs. 11,500" },
    { title: "Family of 4", price: "Rs. 15,000" },
    { title: "Family of 5", price: "Rs. 18,500" }
  ];
      ...
      <Row>
        ...
        {[...groundTickets, ...generalTickets, ...ExtendedPass].map((item, index) => (
          <Col md={4} className="mb-3" key={`std-${index}`}>
            <div className="border p-4 h-100 d-flex flex-column justify-content-between m-shadow">
              <div>
        ...
        {ExtendedAnnualPass.map((pass) => (
          <Col md={4} className="mb-3" key={pass.id}>
            <div className="border p-4 h-100 d-flex flex-column m-shadow">
        ...
        {AnnualPass.map((pass) => (
          <Col md={4} className="mb-3" key={pass.id}>
            <div className="border p-4 h-100 d-flex flex-column m-shadowz">
              {/* FIRST MAPPING PART: Heading and Paragraph */}
              <h3 className="fw-bold fs-4">{pass.heading}</h3>
              <p className="text-muted">{pass.paragraph}</p>
