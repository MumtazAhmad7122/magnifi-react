...
function Electronic() {
  ...
  const videos = [
    { src: "https://www.youtube.com/watch?v=flACsJig-64", title: "Wonder Woman" },
  ...
  const thumbnails = [
    { img: "/src/assets/imagee/thumb1.jpg", title: "
Chief Minister of Sindh, Syed Murad Ali Shah visited TDF's MagnifiScience Centre", duration: "2:30" },
