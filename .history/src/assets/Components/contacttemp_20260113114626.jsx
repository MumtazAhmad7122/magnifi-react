  ...
  return (
    <section className='contact-sec pt-5'>
     ...
     <div className='ct-info'>
      ...
      <p className='pb-4'>We’re here to answer your questions, hear your feedback, and provide the support you need. Whether you want to learn more about our educational resources, explore collaboration opportunities, or simply say hello, our team is ready to assist you.</p>
      <div className='time d-flex align-item-center pb-5'>
       <div className='iconn pe-4 '>
        ...
        <div className='time d-flex align-item-center pb-'>
       <div className='iconn pe-4 '>
